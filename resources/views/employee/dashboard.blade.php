                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        @if($employee->photo)
                            ...
                            <img src="{{asset('uploads/employees/' . $employee->photo)}}" width="100" height="100"
                                class="rounded-circle">


                        @else

                            <img src="{{asset('assets/images/avatars/avatar-1.png')}}" width="100" class="rounded-circle">
        ...
        <div id="employeeTaskChart"></div>
            ...
            <div class="card radius-10 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('employee.holidays.index') }}" class="btn btn-outline-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('employee.leaves.create') }}" class="btn btn-success w-100">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('employee.leaves.index') }}" class="btn btn-warning w-100">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const chartElement = document.querySelector('#employeeTaskChart');
