            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav align-items-center flex-grow-1">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="{{ asset('') }}javascript:;"
        ...
        Create Notice
                            ...
                            <li class="nav-item dropend">
                                ...
                                <ul class="dropdown-menu submenu">
                                    <li class="nav-item dropend"><a
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ asset('') }}errors-404-error.html"><i
                                                        class='bx bx-radio-circle'></i>404 Error</a></li>
                                            <li><a class="dropdown-item" href="{{ asset('') }}errors-500-error.html"><i
                                            ...
                                            <li><a class="dropdown-item" href="{{ asset('') }}error-blank-page.html"><i
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li> <a class="dropdown-item" href="{{ asset('') }}form-radios-and-checkboxes.html"><i
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item dropend">
                                ...
                                <ul class="dropdown-menu submenu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ asset('') }}auth-basic-reset-password.html"><i
                                ...
                                <ul class="dropdown-menu submenu">
                                    ...
                                    <li><a class="dropdown-item"
                                            href="{{ asset('') }}auth-cover-forgot-password.html"><i
                                                class='bx bx-radio-circle'></i>Forgot Password</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}auth-cover-reset-password.html"><i
                                                class='bx bx-radio-circle'></i>Reset Password</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropend">
                                <a class="dropdown-item dropdown-toggle dropdown-toggle-nocaret"
                                    ...
                                    Footer</a>
                                <ul class="dropdown-menu submenu">
                                    <li><a class="dropdown-item" href="{{ asset('') }}auth-header-footer-signin.html"><i
                                                class='bx bx-radio-circle'></i>Sign In</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}auth-header-footer-signup.html"><i
                                                class='bx bx-radio-circle'></i>Sign Up</a></li>
                                    <li><a class="dropdown-item"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropend">
                                ...
                                <ul class="dropdown-menu submenu">
                                    <li><a class="dropdown-item" href="{{ asset('') }}ecommerce-products.html"><i
                            ...
                            <li class="nav-item dropend">
                                ...
                                <ul class="dropdown-menu scroll-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-accordions.html"><i
                                    ...
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-carousels.html"><i
                                                class='bx bx-radio-circle'></i>Carousels</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-list-groups.html"><i
                                                class='bx bx-radio-circle'></i>List Groups</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-media-object.html"><i
                                    ...
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-navs-tabs.html"><i
                                    ...
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-paginations.html"><i
                                    ...
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-progress-bars.html"><i
                                                class='bx bx-radio-circle'></i>Progress</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-spinners.html"><i
                                                class='bx bx-radio-circle'></i>Spinners</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-notifications.html"><i
                                                class='bx bx-radio-circle'></i>Notifications</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}component-avtars-chips.html"><i
                            ...
                            <li class="nav-item dropend">
                                ...
                                <ul class="dropdown-menu submenu">
                                    <li><a class="dropdown-item" href="{{ asset('') }}content-grid-system.html"><i
                                                class='bx bx-radio-circle'></i>Grid System</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}content-typography.html"><i
                                                class='bx bx-radio-circle'></i>Typography</a></li>
                                    <li><a class="dropdown-item" href="{{ asset('') }}content-text-utilities.html"><i
                            ...
                            <li class="nav-item dropend">
                                ...
                                <ul class="dropdown-menu submenu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ asset('') }}icons-feather-icons.html"><i
